...
The course instructors and teaching assistants value the contributions, ideas and perspectives of all students. It is our intent that students from different backgrounds be well-served by this course, that students' learning needs be addressed both in and out of class, and that the diversity that the students bring to this class be viewed as a resource, strength and benefit. Although the instructors are committed to continuous improvement of our practices and our learning environment, we value input from students and your suggestions are encouraged and appreciated. Please let the course director or program leadership know ways to improve the effectiveness of the course for you personally, or for other students or student groups. 
...
- 9:00-9:30 Final Presentation Team 1, How are the dynamics of Nb6 altered by affinity maturation?
- 9:30-10:00 Final Presentation Team 2, Does NMR identify the binding site of SARS-CoV2 Spike for Nb6 and mNb6?
- 10:00-10:30 Final Presentation Team 3, How are the dynamics of Nb6 and mNb6 modulated by binding to Spike?
